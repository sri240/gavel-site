    ...
    <p style = {{fontSize: '25px', 
      ...
      <div class='zoomie' style={{background:'#761b28'}}>
        <div style={{padding: '15px'}}>
          ...
          <p style={{fontSize: '32px', color:'#feeb83', fontWeight:'lighter', clear:'all', marginTop:'12px'}}>Sunday, 9:30 AM - 11:00 AM</p>
          ...
          <p class="filler">Open to 6-12th graders, must have completed Toastmasters 
      ...
      <div style={{padding: '15px'}}>
        ...
        <p class="filler">TOASTMASTER: each meeting has a toastmaster to conduct the meeting, 
        calling up speakers and such</p>
        <p class="filler">GRAMMARIAN: chooses word of the day, keeps track of 
        good and bad uses of grammar throughout the meeting as well as uses of the word of the day</p>
        <p class="filler">AH-COUNTER: keeps track of the filler words and 
        frequency at which they are used for each speaking member</p>
        <p class="filler">TIMER: ensures meeting is proceeding in accordance 
        with the agenda; notifies speakers when they are within the acceptable time limits while they are onstage</p>
        <p class="filler">SPEAKER: presents a speech in accordance with the project 
        in their manual on an appropriate topic</p>
        <p class="filler">EVALUATOR: evaluates the speaker according to the standards in their 
        manual; fills out the evaluation report and presents a report at the end of the meeting</p>
        <p class="filler">TABLE TOPICS MASTER: prepares questions to ask members and calls them 
        up for 1-2 minute impromptu speeches on the topic</p>
        <p class="filler">GENERAL EVALUATOR: evaluates the 
        entire meeting and calls for evaluators and functionary reports</p>
        <p class="title">OFFICERS</p>
        <p class="filler">Every six months, our club holds an election to determine our officers.</p>
        <p class="filler">PRESIDENT: The president is the leader of the club, and picks up any of the 
        jobs that other officers aren't doing. They are responsible for the club running smoothly.</p>
        <p class="filler">VP OF EDUCATION: This officer keeps track of everyone's progress in their 
        manuals, and and helps anyone who needs assistance progressing.</p>
        <p class="filler">VP OF MEMBERSHIP: The VP of Membership is responsible for ensuring members 
        are keeping up with attendance and commitment, as well as determining whether members should be added or removed.</p>
        <p class="filler">VP OF PUBLIC RELATIONS: This officer manages all of the PR of the club, 
        including YLP outreaches and online presence.</p>
        <p class="filler">SECRETARY: The secretary is responsible for taking and sending out detailed 
        meeting notes at every meeting.</p>
        <p class="filler">SERGEANT AT ARMS: This role involves preparing the meeting room beforehand, 
        including making reservations and setting up tables and chairs.</p>
        <p class="filler">WEBMASTER: The webmaster maintains the website and any other technological 
        necessities.</p>
        <p class="title">WHAT ELSE?</p>
        <p class="filler">As an active Gavel Club in the Bay Area, we participate in
