...
const Register = () => (
  <Layout>
    ...
    <div class="reginfo" style={{background:'#a13545', padding:"15px"}}><p class="title">INDUCTION PROCESS</p>
        ...
        STEP 3: Contact the Vice President of Membership (Sohum Tiwary: sohum.tiwary@gmail.com) to get added to the Google Group and WhatsApp group chat for communication.<br></br>
